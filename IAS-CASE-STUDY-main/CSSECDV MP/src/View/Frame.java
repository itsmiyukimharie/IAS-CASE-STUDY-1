...
//                clientBtn.setVisible(true);
    ...
    public void verifycodeNav() {
        frameView.show(Container, "verifycodePnl");
    }

    public void resetpasswordNav(String email) {
        ResetPassword resetPasswordPnl = new ResetPassword(email);
